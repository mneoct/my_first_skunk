...
public class SkunkEndGame {
	public static int finalComparisonGetWinner(int numberOfPlayers, String[] playerNames, ArrayList<SkunkPlayer> players) {
		int winner = 0;
		int winnerScore = 0;
		
		for (int player = 0; player < numberOfPlayers; player++)
		{
			SkunkPlayer nextPlayer = players.get(player);
	...
	public static void finalReport(int winnerIndex, String[] playerNames, ArrayList<SkunkPlayer> players, int numberOfPlayers) {
