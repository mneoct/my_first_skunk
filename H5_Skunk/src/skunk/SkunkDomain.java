	...
	public boolean run()
	{
		...
		while (gameNotOver)
		{
			...
			while (wantsToRoll)
			{
				...
				{
					userInterface.println("Two Skunks! You lose the turn, the round score, plus pay 4 chips to the kitty");
					kitty += 4;
				...
				{
					userInterface.println("One Skunk! You lose the turn, the turn score, plus pay 1 chip to the kitty");
					kitty += 1;
